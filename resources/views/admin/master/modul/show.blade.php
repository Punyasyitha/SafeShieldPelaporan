    ...
    <div class="w-full bg-white shadow-lg rounded-lg mt-6 p-6">
        <div class="overflow-x-auto">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_modul" value="{{ $mod->NAMA_MODUL }}" readonly
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" readonly rows="4"
                    class="w-full mt-1 p-2 border border-gray-300 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 resize-none">{{ $mod->DESKRIPSI }} </textarea>
            </div>
