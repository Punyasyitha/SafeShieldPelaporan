    ...
    <div class="w-full bg-white shadow-lg rounded-lg mt-6 p-6">
        <div class="overflow-x-auto">
            <div class="flex flex-col mb-4">
                ...
                <div class="flex justify-start items-center gap-2 mt-5">
                    <button type="button"
                        onclick="window.location='{{ route('admin.master.kategori.list') }}'"
                        class="bg-gray-300 hover:bg-gray-400 text-black font-semibold py-2 px-4 rounded-lg">
                        <i class="fas fa-circle-left me-1"></i>
                        <span class="font-weight-bold ml-1">Kembali</span>
                    </button>
            ...
            <!-- Tampilkan ID dan Nama Kategori -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700">ID Kategori</label>
                <input type="text" name="idkategori"
                    value="{{ $ktg->IDKATEGORI ?? '-' }}" readonly
                    class="w-full mt-1 p-2 border border-gray-300 bg-gray-100 rounded-lg focus:outline-none">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_kategori"
                    value="{{ $ktg->NAMA_KATEGORI ?? '-' }}" readonly
                    class="w-full mt-1 p-2 border border-gray-300 bg-gray-100 rounded-lg focus:outline-none">
            </div>
        </div>
    </div>
