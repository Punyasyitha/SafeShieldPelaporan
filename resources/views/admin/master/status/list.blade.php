<x-app-layout>
    <div class="w-full bg-white shadow-lg rounded-lg p-6">
        <div class="overflow-x-auto">
            ...
            <div class="overflow-x-auto">
                <table id="statusTable" class="table-fixed border-gray-300 text-sm w-full">
                    {{-- <thead>
                    ...
                    <thead>
                        <tr class="bg-gray-100 text-sm leading-normal">
                            ...
                            <th class="py-3 px-2 min-w-[80px] text-left truncate cursor-pointer sort"
                                data-sort="idstatus">
                                ID Status <i class="fas fa-sort ml-1"></i>
                            </th>
                            <th class="py-3 px-2 min-w-[150px] text-left truncate cursor-pointer sort"
                                data-sort="nama_status">
                                Nama Status <i class="fas fa-sort ml-1"></i>
                            </th>
                    ...
                    <tbody>
                        @foreach ($list as $sts)
                            <tr class="border-b border-gray-300">
                                ...
                                <td class="py-3 px-2 truncate">{{ $sts->idstatus }}</td>
                                <td class="py-3 px-2 truncate">{{ $sts->nama_status }}</td>
                                <td class="py-3 px-2 flex flex-wrap gap-2">
                                    ...
                                    <form action="{{ route('admin.master.status.delete', encrypt($sts->idstatus)) }}"
