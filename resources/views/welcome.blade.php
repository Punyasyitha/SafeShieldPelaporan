...
<body class="min-h-screen bg-gradient-to-b from-fuchsia-50 via-white to-white text-purple-900 antialiased">
            ...
            <div class="flex items-center gap-3">
                @if (Route::has('login'))
                    @auth
                        ...
                        @endphp
                        <a href="{{ $dashboardUrl }}"
                           class="inline-flex items-center rounded-full bg-gradient-to-r from-fuchsia-600 to-purple-600 px-4 py-2 text-sm font-semibold text-white shadow hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-500/50">Ke Dashboard</a>
                    @else
                        <a href="{{ route('login') }}"
                           class="inline-flex items-center rounded-full px-4 py-2 text-sm font-semibold hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/40">Masuk</a>
                    @endauth
                @endif
            </div>
            --}}
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 md:pt-16 pb-16 md:pb-24">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div class="lg:col-span-7">
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight tracking-tight text-purple-900">
                        Laporkan Tindakan<br/>
                        Kekerasan Seksual<br/>
                        di
                        <span class="align-baseline inline-block rounded-xl px-2.5 py-0.5 bg-fuchsia-300/60 ring-1 ring-white/60 shadow-sm">
                            Kampus
                        </span><br/>
                        Bersama SAFESHIELD
                    </h1>
                                ...
                                <a href="{{ $dashboardUrl }}"
                                   class="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-fuchsia-600 to-purple-600 px-6 py-3 text-white font-semibold shadow-lg ring-1 ring-white/20 hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/50">
                                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M3 12h13"/><path d="m10 7 5 5-5 5"/>
                                    </svg>
                                    Buka Dashboard
                                </a>
                            @else
                                <a href="{{ route('login') }}"
                                   class="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-fuchsia-600 to-purple-600 px-6 py-3 text-white font-semibold shadow-lg ring-1 ring-white/20 hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-fuchsia-500/50">
                                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M15 3h4a2 2 0 0 1 2 2v4"/><path d="M10 14 21 3"/><path d="M21 10v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h10"/>
                                    </svg>
                                    Login SAFESHIELD
                                </a>
                            @endauth
                ...
                <div class="relative">
                    ...
                    <div class="mx-auto grid place-items-center w-72 h-72 md:w-80 md:h-80 rounded-full
                    ...
                    <!-- inti + ikon -->
                    <div class="grid place-items-center h-28 w-28 rounded-full bg-white/10 ring-8 ring-white/25 backdrop-blur">
    ...
    <section id="features" class="md:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mt-3 text-slate-600">Didesain untuk keamanan, kecepatan, dan transparansi proses pelaporan.</p>
            </div>
            ...
            <div class="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <a href="{{ url('/regulasi') }}" aria-label="Regulasi Resmi PPKPT"
                   class="group block rounded-3xl bg-white/80 p-6 border border-purple-900/10 shadow transition transform-gpu hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-500/50">
                    <div class="h-10 w-10 rounded-xl bg-fuchsia-600/10 text-fuchsia-700 flex items-center justify-center group-hover:bg-fuchsia-600/15 group-hover:text-fuchsia-600">
                ...
                <a href="{{ url('/edukasi-kekerasan') }}" aria-label="Buka halaman Edukasi Kekerasan"
                   class="group block rounded-3xl bg-white/80 p-6 border border-purple-900/10 shadow transition transform-gpu hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-fuchsia-500/50">
                    ...
                    <p class="mt-1 text-sm text-slate-600">Edukasi bentuk kekerasan khususnya kekerasan seksual.</p>
                </a>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-10 max-w-3xl mx-auto space-y-4">
                <details class="group rounded-2xl bg-white/80 border border-purple-900/10 shadow">
                    <summary class="flex items-center justify-between w-full px-5 py-4 cursor-pointer select-none hover:bg-white/90 rounded-2xl">
                ...
                <details class="group rounded-2xl bg-white/80 border border-purple-900/10 shadow">
                    <summary class="flex items-center justify-between w-full px-5 py-4 cursor-pointer select-none hover:bg-white/90 rounded-2xl">
                        <span class="font-semibold">Bagaimana cara melaporkan tindakan kekerasan atau pelecehan seksual di PENS?</span>
                        <i class="fa-solid fa-chevron-down transition-transform duration-300 group-open:rotate-180"></i>
                    </summary>
                    <div class="p-4 border-t border-purple-900/10 text-sm text-slate-600">
    ...
    <section class="py-14 md:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-fuchsia-600 to-purple-600 p-8 md:p-12 text-white shadow-xl">
                <div class="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-white/15 blur-2xl" aria-hidden="true"></div>
                <div class="max-w-2xl">
                    <h2 class="text-2xl md:text-3xl font-extrabold">Kontak kami</h2>
                    <p class="mt-2 text-white/90">Jika Anda memiliki pertanyaan atau membutuhkan bantuan, jangan ragu untuk menghubungi kami.</p>
                    <br/>
                    <p class="text-sm text-white/80"><i class="fas fa-building mr-2 text-white"></i>Jl. Raya ITS - Kampus PENS, Sukolilo, Surabaya</p>
                    <p class="text-sm text-white/80">
                        <a href="mailto:ppk@div.pens.ac.id" class="underline decoration-white/60 underline-offset-4 hover:decoration-white">
