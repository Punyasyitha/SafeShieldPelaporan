<x-app-layout>
    <form id="iniForm" action="{{ route('master.kategori.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="w-full bg-white shadow-lg rounded-lg p-6">
            <div class="overflow-x-auto">
                <div class="flex flex-col mb-4">
                    <h6 class="text-lg font-bold mb-2">INSERT KATEGORI</h6>
                    <hr class="horizontal dark mt-1 mb-2">

                    <!-- Tombol Kembali dan Simpan di kiri -->
                    <div class="flex justify-start items-center gap-2 mt-5">
                        <button type="button" onclick="window.location='{{ route('master.kategori.list') }}'"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="idkategori" readonly
