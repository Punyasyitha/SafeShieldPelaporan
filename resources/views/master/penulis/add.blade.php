<x-app-layout>
    <form id="iniForm" action="{{ route('master.penulis.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="overflow-x-auto">
                <div class="flex flex-col mb-4">
                    ...
                    <div class="flex justify-start items-center gap-2 mt-5">
                        <button type="button" onclick="window.location='{{ route('master.penulis.list') }}'"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="idpenulis" readonly
